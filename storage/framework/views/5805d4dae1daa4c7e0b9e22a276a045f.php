...
<div class="h-[100vh] bg-[#2C3333] flex justify-center items-center">
    <?php echo csrf_field(); ?>
    <form class="drop-shadow-xl z-0 bg-[#D9D9D9] font-montserrat flex rounded-[20px] w-[500px] justify-left items-left flex-col p-[50px]" method="POST"  action=<?php echo e(route('login_action')); ?>>
        <?php echo csrf_field(); ?>
