...
<div class="h-[100vh] bg-[#2C3333] flex justify-center items-center">
    <form class="p-[60px] w-[600px] drop-shadow-xl z-0 bg-[#D9D9D9] font-montserrat flex rounded-[25px] justify-left items-left flex-col p-[50px]" method="POST"  action=<?php echo e(route('sign_in_action')); ?>>
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('isGuest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\agilg\OneDrive\Desktop\project\projectsangkuni\resources\views/signin.blade.php ENDPATH**/ ?>