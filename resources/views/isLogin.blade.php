...
<body>
    <nav class="z-40 fixed bg-[#2C3333] w-screen h-28 xl:h-24  flex flex-grid justify-between items-center p-[10px] border-b-2 border-[#F0E9D2]">
        ...
        <div class="flex justify-row items-center">
            <a class="text-[#F0E9D2]  font-thin mr-[10px] no-underline font-montserrat hover:text-[#cfc7b0] hover:no-underline " href={{ route('home') }}>Home</a>
            <a class="text-[#F0E9D2]  font-thin mr-[10px] no-underline font-montserrat hover:text-[#cfc7b0] hover:no-underline " href={{ route('showcase') }}>Product</a>
            <a class="text-[#F0E9D2]  font-thin mr-[10px] no-underline font-montserrat hover:text-[#cfc7b0] hover:no-underline " href={{ route('home') }}>about</a>
    ...
    <footer class="bg-[#2C3333] p-[30px] border-t-2 border-[#F0E9D2]  flex flex-grid justify-between items-center justify-row">
        <div class="ml-[100px]">
            ...
            <div class="border-[#F0E9D2] mr-[20%] border-l-2 ml-[100px] pl-[10px]">
                <h4 class="text-[#F0E9D2]">Sosial Media</h4>
                <div class=" text-[#F0E9D2] flex justify-left m-[10px] justify-col">
