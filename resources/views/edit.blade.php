...
@section('content')
<div class="h-[20vh] bg-[#2C3333] flex justify-center items-center">
    <h1>Edit</h1>
</div>
<div class=" bg-[#2C3333]  h-[100vh] flex justify-center items-center ">
    <form class="drop-shadow-xl z-0 bg-[#D9D9D9] font-montserrat flex rounded-[20px] justify-left items-left flex-col p-[50px] lg:p-[10px]" method="post" enctype="multipart/form-data" action={{ route('edit_action') }}>
            @csrf
