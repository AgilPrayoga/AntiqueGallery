...
<div class=" bg-[#2C3333]  h-[100vh] xl:p-[50px]  flex justify-center items-center ">
        <form class="drop-shadow-xl z-0 bg-[#D9D9D9] font-montserrat flex rounded-[20px] justify-left items-left flex-col xl:p-[50px] xl:p-[10px]" method="POST" enctype="multipart/form-data" action={{ route('dashboard_action') }}>
                @csrf
