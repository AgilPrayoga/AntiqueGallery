...
<div class="h-[100vh] bg-[#2C3333] flex justify-center items-center">
    @csrf
    <form class="drop-shadow-xl z-0 bg-[#D9D9D9] font-montserrat flex rounded-[20px] w-[500px] justify-left items-left flex-col p-[50px]" method="POST"  action={{route('login_action')}}>
        @csrf
